...
var logger = log4js.getLogger('TRACEAPI');
...
app.get('/orders', awaitHandler(async (req, res) => {
	logger.info('================ GET on ORDER');
	let args = {};
	let fcn = "queryAllOrders";
...
// GET a specific NGO
app.get('/orders/:orderId', awaitHandler(async (req, res) => {
	logger.info('================ GET on ORDER by ID');
	logger.info('ORDER orderId : ' + req.params);
	let args = req.params;
	let fcn = "queryOrder";
...
app.get('/orders/:orderId/donations', awaitHandler(async (req, res) => {
...
//     logger.info('##### dummySpend GET on ORDER - username : ' + username);
// 	logger.info('##### dummySpend GET on ORDER - userOrg : ' + orgName);
// 	logger.info('##### dummySpend GET on ORDER - channelName : ' + channelName);
// 	logger.info('##### dummySpend GET on ORDER - chaincodeName : ' + chaincodeName);
// 	logger.info('##### dummySpend GET on ORDER - fcn : ' + fcn);
// 	logger.info('##### dummySpend GET on ORDER - args : ' + JSON.stringify(args));
// 	logger.info('##### dummySpend GET on ORDER - peers : ' + peers);
...
// 	}
// 	logger.info('##### dummySpend - number of ORDER record: ' + len);
// 	if (len < 1) {
// 		return;
// 	}
// 	let ran = Math.floor(Math.random() * len);
// 	logger.info('##### dummySpend - randomly selected ORDER record number: ' + ran);
// 	logger.info('##### dummySpend - randomly selected ORDER record: ' + JSON.stringify(message[ran]));
// 	let order = message[ran]['orderId'];
// 	logger.info('##### dummySpend - randomly selected ORDER: ' + order);
